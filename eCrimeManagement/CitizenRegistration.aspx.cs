      ...
      /*  protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            if (IsPostBack)
            {
                ...
                if (status == 0)
                {
                    SqlConnection con1 = new SqlConnection("Data Source=.\\sqlexpress;Initial Catalog=project;Integrated Security=True;Pooling=False");
                    SqlConnection con2 = new SqlConnection("Data Source=.\\sqlexpress;Initial Catalog=project;Integrated Security=True;Pooling=False");
                    SqlCommand cmdDetail = new SqlCommand("Insert into CitizenDetails values(@Userid,@Nam,@Gen,@DOB,@Add,@State,@Dist,@Pin,@Phn,@Vot,@PAN,@Aadhar,@ref,@AuthPS,@Mail)", con2);
                    ...
                    cmdDetail.Parameters.AddWithValue("@ref", lblRef .Text  );
                    cmdDetail.Parameters.AddWithValue("@AuthPS","");
                    cmdDetail.Parameters.AddWithValue("@Mail", txtMail.Text);
                    ...
                    Session["MSG"] = "YOU HAVE SUCCESSFULLY REGISTERED <br />YOUR RefID is " + this.getREFID() + " and <br />USERID is " + txtUser.Text+"<br />Please go to nearby Police Station and verify yourself.";
