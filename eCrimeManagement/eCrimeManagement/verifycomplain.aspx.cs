...
{
    public partial class VerifyComplain : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string query = "select * from ComplainData where PoliceStation= '" + (String)Session["StnName"] + "'";
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Session["RefId"] = RefID;
            Response.Redirect("VerifyThisComplain.aspx");
        }

        protected void BindGridUID()
        {
            string query = "select * from ComplainData where ComplainID= '" + txtID .Text + "'";
            SqlDataAdapter da = new SqlDataAdapter(query, con);
        ...
        {
            string query = "select * from ComplainData where Status= '" + cmbStatus .SelectedItem  + "'";
            SqlDataAdapter da = new SqlDataAdapter(query, con);
