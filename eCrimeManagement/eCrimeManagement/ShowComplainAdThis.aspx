<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ShowComplainAdThis.aspx.cs" Inherits="eCrimeManagement.ShowComplainAdThis" %>
...
<asp:Label ID="Label3" runat="server" 
    ...
    <asp:Button ID="btnClose" runat="server" onclick="btnClose_Click" 
        style="z-index: 1; left: 563px; top: 754px; position: absolute; right: 475px" 
        Text="OK" />
    <asp:Label ID="lblTime" runat="server" 
        style="z-index: 1; left: 421px; top: 180px; position: absolute" 
        Text="This file reported at  "></asp:Label>
    <asp:DropDownList ID="cmbChngSta" runat="server" AutoPostBack="True" 
        onselectedindexchanged="cmbChngSta_SelectedIndexChanged" 
        style="z-index: 1; left: 892px; top: 463px; position: absolute; width: 132px">
    </asp:DropDownList>
    <asp:Label ID="Label15" runat="server" 
        style="z-index: 1; left: 727px; top: 464px; position: absolute; width: 153px" 
        Text="CHANGE STATUS TO"></asp:Label>
    <asp:Button ID="btnUpdate" runat="server" onclick="btnUpdate_Click" 
        style="z-index: 1; left: 645px; top: 757px; position: absolute" Text="UPDATE" />
