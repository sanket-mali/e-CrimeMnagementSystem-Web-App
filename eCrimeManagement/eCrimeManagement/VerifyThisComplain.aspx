<%@ Page Title="" Language="C#" MasterPageFile="~/Station.Master" AutoEventWireup="true" CodeBehind="VerifyThisComplain.aspx.cs" Inherits="eCrimeManagement.VerifyThisComplain" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label10" runat="server" 
        style="z-index: 1; left: 393px; top: 475px; position: absolute" Text="STATUS"></asp:Label>
    <asp:Label ID="Label11" runat="server" 
        style="z-index: 1; left: 391px; top: 431px; position: absolute; height: 38px; width: 121px" 
        Text="TIME OF INCIDENT"></asp:Label>
    <asp:TextBox ID="txtTime" runat="server" 
        style="z-index: 1; left: 525px; top: 444px; position: absolute; width: 194px" 
            Enabled="False"></asp:TextBox>
    <asp:TextBox ID="txtStatus" runat="server" 
        style="z-index: 1; left: 526px; top: 474px; position: absolute; width: 193px" 
            Enabled="False"></asp:TextBox>
    ...
    <asp:Label ID="lblTime" runat="server" 
        ...
        style="z-index: 1; left: 556px; top: 764px; position: absolute; width: 80px; height: 26px;" 
        Text="VERIFY" />
        <asp:Button ID="btnOk" runat="server" onclick="btnOk_Click" 
            style="z-index: 1; left: 698px; top: 765px; position: absolute" Text="OK" />
</div>
</asp:Content>
