<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CloseFileAdmin.aspx.cs" Inherits="eCrimeManagement.CloseFileAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="Panel1" runat="server" 
        ...
        style="z-index: 1; left: 333px; top: 321px; position: absolute; height: 482px; width: 712px;overflow:scroll;">
    ...
    <asp:Button ID="Button9" runat="server" onclick="Button9_Click" 
        ...
        <asp:Label ID="Label5" runat="server" 
            style="top: 267px; left: 807px; position: absolute; height: 19px; width: 34px" 
