<%@ Page Title="" Language="C#" MasterPageFile="~/Station.Master" AutoEventWireup="true" CodeBehind="VerifyComplain.aspx.cs" Inherits="eCrimeManagement.VerifyComplain" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label3" runat="server" 
        ...
        Text="VERIFY COMPLAINS"></asp:Label>
    ...
    <asp:TextBox ID="txtID" runat="server" 
        ...
        <asp:Button ID="btnSearch" runat="server" onclick="btnSearch_Click" 
            style="z-index: 1; left: 626px; top: 345px; position: absolute" Text="SEARCH" />

    <asp:Panel ID="Panel1" runat="server" 
        style="z-index: 1; left: 350px; top: 371px; position: absolute; height: 405px; width: 691px; overflow:scroll">
