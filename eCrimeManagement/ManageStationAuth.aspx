<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ManageStationAuth.aspx.cs" Inherits="eCrimeManagement.ManageStationAuth" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label3" runat="server" 
        ...
        Text="SEARCH STATIONS"></asp:Label>
    ...
    <asp:DropDownList ID="cmbPS" runat="server" 
        ...
        style="z-index: 1; left: 594px; top: 375px; position: absolute; width: 180px" 
        AutoPostBack="True">
    </asp:DropDownList>
    ...
    <asp:Panel ID="Panel1" runat="server" 
            ...
            style="z-index: 1; left: 344px; top: 463px; position: absolute; height: 255px; width: 694px;overflow:scroll;">
        <asp:GridView ID="GridView1" runat="server" 
    AutoGenerateSelectButton="True" 
    onselectedindexchanged="GridView1_SelectedIndexChanged1" 
    
            
            style="z-index: 1; left: 0px; top: 0px; position: absolute; height: 133px; width: 941px" 
